...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        # batch_size, feature_map_height, feature_map_width, feature_map_channels = batch_size.value if batch_size else None, feature_map_height.value, feature_map_width.value, feature_map_channels.value
